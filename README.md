...
def deploy_or_update_prompt():
    ...
    system_text = """You are an expert incident orchestration agent responsible for coordinating a multi-stage analysis pipeline.
(Insert your full system prompt text here, including {{environment}} variables)"""
    ...
    try:
        ...
        if existing_prompt_id:
            ...
            final_prompt_id = create_response['prompt']['id']
